...
export default function Home() {
  ...
  // Define FloatingSparkles component
  ...
  return (
    <div className="min-h-screen font-geist relative">
      ...
      {/* Secondary Background Layer with Conic Gradient */}
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/70' : 'bg-white/60'} backdrop-blur-xl border-b border-gray-100/20 shadow-sm`}>
        {/* Subtle gradient */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            <Link href="/" className="flex items-center group relative">
              <div className="absolute -inset-2 bg-gradient-to-r from-[#00ffe0]/0 via-[#00ffe0]/10 to-[#00ffe0]/0 rounded-lg blur-md opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
              <VersaLogo animated={true} size="md" gradient={true} className="relative z-10" />
            </Link>
            <div className="flex items-center gap-3 sm:gap-6">
              <Link href="/about" className="hidden sm:block text-sm text-[#0f0f0f]/80 hover:text-[#0f0f0f] transition-all font-medium cursor-pointer hover:scale-105 relative group">
                About
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#00ffe0] to-[#b8a1ff] group-hover:w-full transition-all duration-300"></span>
              </Link>
              <Link href="/auth/signin" className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-[#00ffe0] to-[#00ffe0]/90 text-[#0f0f0f] text-xs sm:text-sm font-medium rounded-md hover:bg-[#00ffe0]/90 transition-all shadow-[0_0_15px_rgba(0,255,224,0.3)] cursor-pointer hover:scale-105 hover:shadow-[0_0_25px_rgba(0,255,224,0.5)] relative overflow-hidden group">
                <span className="relative z-10">Launch</span>
                <span className="absolute inset-0 bg-gradient-to-r from-[#00ffe0]/0 via-white/20 to-[#00ffe0]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></span>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 sm:py-28 md:py-32 lg:py-40 relative overflow-visible">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-1">
          <motion.div
            className="px-4 sm:px-0 relative"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 1 }}
          >
            ...
            <div className="relative px-4 sm:px-0">
              ...
              >
                ...
                <p className="mt-8 text-sm text-[#0f0f0f]/65 font-playfair italic">
                  Versa awaits.
                </p>
              </motion.div>
            </div>
